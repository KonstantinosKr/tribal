...
int main (int argc, char **argv)
{
  ...
  int num_import, num_export, *import_procs, *import_to_parts, *export_procs, *export_to_parts;
  ...
  //for(time = 0; time < 1; time++)
  {
    ...
    loba_balance (lb, nt, t[0], tid, 1.1,
                  &num_import, &import_procs, &import_to_parts, 
                  &num_export, &export_procs, &export_to_parts,
